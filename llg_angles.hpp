...
namespace llg {
  ...
  double get_cosphi_alt1(TLorentzVector const & lep_minus, TLorentzVector const & lep_plus, TLorentzVector const & gamma) {
    TLorentzVector gamma_p4 = gamma;
    TLorentzVector l1_p4 = lep_minus;
    TLorentzVector ll_p4 = lep_minus + lep_plus;
    TLorentzVector llg_p4 = ll_p4 + gamma_p4;
  ...
  double get_phi_alt2(TLorentzVector const & lep_minus, TLorentzVector const & lep_plus, TLorentzVector const & gamma) {
    TLorentzVector gamma_p4 = gamma;
    TLorentzVector l1_p4 = lep_minus;
    TLorentzVector ll_p4 = lep_minus + lep_plus;
    TLorentzVector llg_p4 = ll_p4 + gamma_p4;
